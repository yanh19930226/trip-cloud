package com.trip.auth.interceptor;

import com.trip.auth.anno.RequireLogin;
import com.trip.auth.config.JwtProperties;
import com.trip.auth.util.AuthenticationUtils;
import com.trip.core.exception.BusinessException;
import com.trip.redis.utils.RedisCache;
import com.trip.user.key.UserRedisKeyPrefix;
import com.trip.user.vo.LoginUser;
